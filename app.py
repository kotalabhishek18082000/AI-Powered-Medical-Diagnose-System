...
background_image_url = "https://media.istockphoto.com/id/1468430468/photo/medical-technology-doctor-use-ai-robots-for-diagnosis-care-and-increasing-accuracy-patient.jpg?s=612x612&w=0&k=20&c=KqQbjGMVakHNTJOeh3LVeiqwZWF4Kt5j3taoJXY4x80="  # Replace with your image URL
...
models = {
    ...
    'heart_disease': pickle.load(open('heart_diseases_model.sav', 'rb')),
    'parkinsons': pickle.load(open('parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open('lung_diseases_model.sav', 'rb')),
